...
export function cadenceToCron(policy: MonitorPolicy): string {
  ...
  if (policy.cadence === 'Daily') return `${minute} ${hour} * * *`;
...
# This workflow defaults to a self-hosted Linux runner because local files, network shares, and private databases are not reachable from GitHub-hosted runners.
